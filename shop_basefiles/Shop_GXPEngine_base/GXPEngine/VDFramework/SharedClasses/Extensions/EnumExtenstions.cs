...
namespace VDFramework.Extensions
{
	public static class EnumExtentions
	{
		...
		public static IEnumerable<string> GetNames<TEnum>(this TEnum @enum) where TEnum : Enum
		{
		...
		/// </summary>
		public static IEnumerable<TEnum> GetValues<TEnum>(this TEnum @enum) where TEnum : struct, Enum
		{
		...
		public static TEnum GetRandomValue<TEnum>(this TEnum @enum) where TEnum : struct, Enum
		{
